...
def upload_file_stat():
    ...
    try:
        ...
        try:
            if filename.endswith('.csv'):
                read_attempts = [
                    # Diferentes configuraciones de delimitador y separador decimal
            ...
            dataframe.replace(["N/A", "n/a", ""], np.nan, inplace=True)
            dataframe.dropna(how='all', inplace=True)  # Eliminar filas completamente vacías

            # Convertir todas las columnas numéricas con separador decimal
